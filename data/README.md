...
- `npm run db:seed:uttarakhand-govt` — **Uttarakhand govt** (`uttarakhand_govt_colleges_data.sql`)
- `npm run db:seed:himachal-pradesh` — **Himachal Pradesh facts** (`himachal_pradesh.sql`)
- `npm run db:seed:manipur` — **Manipur private** (`manipur_data.sql`)
- `npm run db:seed:manipur-govt` — **Manipur govt** (`manipur_govt_colleges_data.sql`)
