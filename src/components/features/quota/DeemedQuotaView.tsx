...
const DEEMED_QUOTA_JUMP_SECTIONS = [
  { id: "overview", label: "Overview" },
  { id: "rules", label: "Counselling Rules" },
  { id: "eligibility", label: "Eligibility" },
  { id: "choice-checklist", label: "Choice Checklist" },
  { id: "rounds", label: "Counselling Rounds" },
  { id: "seat-distribution", label: "Seat Distribution" },
] as const;
...
export function DeemedQuotaView() {
  ...
  return (
    ...
    >      {/* Overview Group */}
      ...
      <div id="choice-checklist" className="scroll-mt-20">
        <QuotaProcessList
          className=""
      ...
      <section id="rounds" className="scroll-mt-20">
        <div className="mb-8">
