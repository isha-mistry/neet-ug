...
const NRI_QUOTA_JUMP_SECTIONS = [
  { id: "overview", label: "Overview" },
  { id: "eligibility-fees", label: "Eligibility & Fees" },
  { id: "sponsorship-rules", label: "Sponsorship Rules" },
  { id: "documentation", label: "Mandatory Documentation" },
  { id: "state-distribution", label: "State Distribution" },
  { id: "embassy-guide", label: "Embassy Guide" },
] as const;
...
export function NriQuotaView() {
  ...
  return (
    <QuotaPageShell
      ...
      header={header}
      sidebar={sidebar}
      jumpSections={NRI_QUOTA_JUMP_SECTIONS}
    >
      {/* Overview Group */}
      ...
      {/* Eligibility & Fees */}
      <section id="eligibility-fees" className="scroll-mt-20">
        <div className="mb-6">
      ...
      <section id="state-distribution" className="scroll-mt-20">
        <div className="mb-6">
