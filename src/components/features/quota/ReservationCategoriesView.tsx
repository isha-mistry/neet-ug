...
export function ReservationCategoriesView() {
  ...
  return (
    ...
    >
      ...
      <section className="scroll-mt-20 rounded-2xl border border-outline-variant/40 bg-surface shadow-[0_1px_2px_rgba(0,0,0,0.04),0_12px_32px_-18px_rgba(37,70,208,0.18)] p-5 md:p-6" id="vertical">
      ...
      <section className="scroll-mt-20 overflow-hidden rounded-2xl border border-outline-variant/40 bg-surface shadow-[0_1px_2px_rgba(0,0,0,0.04),0_12px_32px_-18px_rgba(37,70,208,0.18)] p-5 md:p-6" id="breakdown">
      ...
      <section className="scroll-mt-20 rounded-2xl border border-outline-variant/40 bg-surface shadow-[0_1px_2px_rgba(0,0,0,0.04),0_12px_32px_-18px_rgba(37,70,208,0.18)] p-5 md:p-6" id="horizontal">
        <div className="flex items-center gap-3 mb-6">
      ...
      {/* Info Alert */}
      <div id="verification-step" className="scroll-mt-20 bg-primary-container/10 border-l-4 border-primary p-6 rounded-r-xl border border-outline-variant/10 shadow-sm space-y-4">
      ...
      <section className="mt-12 rounded-3xl border border-outline-variant/40 bg-linear-to-br from-surface-container-lowest via-surface-container-lowest to-primary/[0.03] p-6 shadow-[0_1px_2px_rgba(0,0,0,0.04),0_12px_32px_-18px_rgba(37,70,208,0.18)] md:p-8">
