...
export function NtaHelpdeskCard() {
  return (
    <Card className="rounded-[12px] border border-slate-200 bg-white p-6 shadow-[0_10px_30px_rgba(15,23,42,0.045)] text-left">
      <div className="flex flex-col gap-4 text-left">
        <div className="flex h-11 w-11 items-center justify-center rounded-[10px] bg-rose-50 text-rose-600 border border-rose-100/40">
        ...
        <div className="flex flex-col gap-2 pt-2 border-t border-slate-100">
          <a
            ...
            className="h-10 w-full rounded-[10px] bg-slate-50 hover:bg-slate-100/80 border border-slate-200 text-slate-700 flex items-center justify-center text-xs font-bold no-underline transition-colors cursor-pointer"
          >
            NTA NEET Portal
