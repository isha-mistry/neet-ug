    ...
    <section className="py-16 bg-surface">
      <Container size="page">
        ...
        <div className="space-y-12">
          {/* Category 1 */}
          <div className="rounded-[1.75rem] bg-linear-to-br from-primary/55 via-primary-fixed to-surface-container-low p-px shadow-[0_20px_56px_-30px_color-mix(in_srgb,var(--color-primary)_50%,transparent)]">
            <div className={cn(guideCardClass, "group grid md:grid-cols-12 gap-8 items-center rounded-[calc(1.75rem-1px)] border-0")}>
              ...
              <div className="md:col-span-8 grid gap-4 sm:grid-cols-2">
                <div className={cn(summaryHighlightCardClass, "border-outline-variant/40 hover:bg-surface-container-low/45 transition-colors flex flex-col justify-between")}>
                  <div>
          ...
          {/* Category 2 */}
          <div className={cn(guideCardClass, "group grid md:grid-cols-12 gap-8 items-center border-outline-variant/40 hover:border-primary/25 transition-all duration-300")}>
            <div className="md:col-span-4 space-y-4">
              <div className="w-12 h-12 rounded-2xl bg-primary-fixed text-primary flex items-center justify-center transition-transform group-hover:scale-105 duration-300">
