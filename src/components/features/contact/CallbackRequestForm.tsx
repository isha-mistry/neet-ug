                        ...
                        <div className="lg:col-span-7">
                            {submitted ? (
                                ...
                                <form onSubmit={handleSubmit} className="space-y-6">
                                    <div className="grid gap-4 sm:grid-cols-3">
                                        <div>
                                            ...
                                            <input
                                                ...
                                                className="w-full rounded-xl border border-outline-variant/60 bg-surface-container-low/50 px-4 py-3 text-xs text-on-surface placeholder:text-outline focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20"
                                            />
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <select
                                                ...
                                                className="w-full rounded-xl border border-outline-variant/60 bg-surface-container-low/50 px-3 py-3.5 text-xs text-on-surface focus:border-primary focus:outline-none"
                                            >
                                                {TIME_SLOTS.map((slot) => (
                                    ...
                                    <button
                                        type="submit"
                                        className="w-full rounded-xl bg-primary py-4 font-bold text-xs text-on-primary shadow-sm hover:bg-primary-hover active:scale-[0.98] transition-all cursor-pointer flex items-center justify-center gap-1.5"
                                    >
