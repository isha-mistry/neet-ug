/**
 * Dravio Design System (single source of truth).
 *
...
export const dravioTheme = {
  ...
  colors: {
    ...
    onPrimaryContainer: "#0e1b33",
    primaryHover: "#1e3bad",
    primaryPressed: "#0f2c9c",
    ...
    primaryFixed: "#eaf0ff",
    primaryFixedDim: "#bbd0ff",
    onPrimaryFixed: "#0e1b33",
    onPrimaryFixedVariant: "#1e3bad",
  ...
  shadow: {
    ...
    focus: "0 0 0 4px rgba(37, 70, 208, 0.25)",
    primaryButton: "0 10px 28px -10px rgba(37, 70, 208, 0.45)",
    primaryButtonHover: "0 14px 36px -10px rgba(37, 70, 208, 0.55)",
    primaryGlow: "0 15px 35px rgba(37, 70, 208, 0.35)",
  },
...
export type DravioTheme = typeof dravioTheme;
