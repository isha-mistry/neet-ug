...
export const GUJARAT_MBBS_CONFIG: MbbsStateConfig = {
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        "MedSeat’s catalog lists 48 medical colleges and 7,975 MBBS seats for Gujarat, with about 4,425 government/GMERS seats and 3,550 private seats. Confirm final matrix numbers on medadmgujarat.org when ACPUGMEC publishes the admission year notification.",
    },
    {
